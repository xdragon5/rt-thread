...
static isr_handler_t isr_handler_table[IRQ_MAX];
 ...
 ******************************************************************************/
static void ls1c101_irq_default_isr(void)
{

}
/******************************************************************************
* Name: 	 ls1c101_irq_pmu_evt_isr
*
* Desc: 	 PMU事件中断处理函数
* Param:     无
* Return:    无
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
static void ls1c101_irq_pmu_evt_isr(void)
{
    ...
    for(idx=0; idx<5; idx++)
    {
        ...
        {
            isr_handler_table[idx+IRQ_BAT_FAIL]();
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
static void ls1c101_irq_intc_isr(void)
{
    ...
    for(idx=0; idx<8; idx++)
    {
        ...
        {
            isr_handler_table[idx+IRQ_TIMER]();
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
static void ls1c101_irq_exti_isr(void)
{
    ...
    for(idx=0; idx<32; idx++)
    {
        ...
        {
            isr_handler_table[idx+IRQ_EXTI0]();
...
void ls1c101_irq_init(void)
{
    ...
    {
        isr_handler_table[idx] = ls1c101_irq_default_isr;
    }
}

/******************************************************************************
* Name: 	 ls1c101_irq_enable
*
* Desc: 	 开启CPU全局中断
* Param:     无
* Return:    无
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
void ls1c101_irq_mask(int vector)
{
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
void ls1c101_irq_unmask(int vector)
{
...
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
void ls1c101_irq_install(int vector, isr_handler_t isr_handler)
{
    if(vector < IRQ_MAX) isr_handler_table[vector] = isr_handler;
}

/******************************************************************************
* Name: 	 ls1c101_irq_dispatch
*
* Desc: 	 CPU中断源IP0-IP7处理函数
* Param:     无
* Return:    无
* Global:
* Note:      见LS1C101用户手册与CP0寄存器说明
* Author: 	 zhuangwei
* -------------------------------------
* Log: 	 2018/11/11, Create this function by zhuangwei
 ******************************************************************************/
void ls1c101_irq_dispatch(void)
{
    ...
    else if (pending_im & CAUSEF_IP3)//触摸按键中断
    {
		...
		{
			isr_handler_table[IRQ_TOUCH_KEY]();
